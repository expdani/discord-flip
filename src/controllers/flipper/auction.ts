...
import { AUCTION_CHANNEL, TypeAuction } from "./types";
import {
  empty,
  findIcon,
  getStarIcons,
...
import { client } from "../..";
import { getActiveAuctions } from "../../apollo/flipper";
 ...
 */
export async function fetchAuctions(): Promise<void> {
  const bins = await getActiveAuctions(50);
